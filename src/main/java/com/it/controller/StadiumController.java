...
public class StadiumController {
	...
	@GetMapping("/{stdmId}")
	public ResponseEntity<Object> getStadiumByStdmId(@PathVariable(name = "stdmId")String stdmId) {
	...
	public ResponseEntity<Object> updateStadium(
			@PathVariable(name = "stdmId") String stdmId,
	...
	public ResponseEntity<Object> deleteStadiumByStdmId(@PathVariable(name = "stdmId") String stdmId){
	return ResponseEntity.ok(stadiumService.deleteStadiumByStdmId(stdmId));
}
